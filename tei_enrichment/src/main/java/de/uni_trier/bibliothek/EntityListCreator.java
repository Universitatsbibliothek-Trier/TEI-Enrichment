...
public class EntityListCreator {
	...
	public static String createList(String xmlFile)
	{
		
		// insert TEI-Schema for easier validation
		String xmlFileSchema = xmlFile.replaceAll("<TEI version=\"5.0\"", "<TEI version=\"5.0\"  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.tei-c.org/ns/1.0 https://www.tei-c.org/release/xml/tei/custom/schema/xsd/tei_all.xsd\"");
