...
package de.uni_trier.bibliothek.xml.places;
...
import de.uni_trier.bibliothek.xml.places.model.generated.TEI;

public class PlacesMarshaller<T> 
{
    ...
    public static List<String> marshall(List<TEI> teiObjects) throws JAXBException {
        ...
        {
            String teiXml = PlacesMarshaller.marshall(teiObject);
