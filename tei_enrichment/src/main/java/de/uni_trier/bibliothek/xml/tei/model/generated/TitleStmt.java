 ...
 *       <sequence>
 *         <element name="title" type="{http://www.tei-c.org/ns/1.0}TitleStmtValue"/>
...
public class TitleStmt {
    ...
    protected TitleStmtValue title;
    @XmlElement(required = true)
     ...
     *     
     */
    public TitleStmtValue getTitle() {
        return title;
    }
     ...
     *     
     */
    public void setTitle(TitleStmtValue value) {
        this.title = value;
    }
