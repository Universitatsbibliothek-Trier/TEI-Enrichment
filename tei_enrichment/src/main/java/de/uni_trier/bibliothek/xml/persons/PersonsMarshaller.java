...
package de.uni_trier.bibliothek.xml.persons;
...
import de.uni_trier.bibliothek.xml.persons.model.generated.TEI;

public class PersonsMarshaller<T> 
{
    ...
    public static List<String> marshall(List<TEI> teiObjects) throws JAXBException {
        ...
        {
            String teiXml = PersonsMarshaller.marshall(teiObject);
